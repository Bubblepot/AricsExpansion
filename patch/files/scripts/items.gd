...
###---End Expansion---###
###---Added by Expansion---### Bubblepot exploration enablers
	mouthbreather = {
		code = 'mouthbreather',
		name = 'Mouthbreather',
		icon = null,
		description = "A mouthpiece that allows one to breathe underwater. ",
		effect = '',
		recipe = '',
		reqs = null,
		cost = 400,
	...
	refinedmouthbreather = {
		code = 'refinedmouthbreather',
		name = 'Refined Mouthbreather',
		icon = null,
		description = "A mouthpiece that allows one to breathe very thin air. ",
		effect = '',
		recipe = '',
		reqs = null,
		cost = 400,
	...
	autowings = {
		...
		name = 'Auto Wings',
		icon = null,
		description = "A pair of magi-mechanical wings. Allows flight.",
		effect = [{type = 'incombat', effect = 'speed', effectvalue = 2 ,descript = "Speed + 2"}],
		recipe = '',
		reqs = null,
		cost = 400,
		type = 'gear',
	...
	divingsuit = {
		...
		name = 'Diving Suit',
		icon = null,
		description = "A suit magically enhanced to withstand enormous pressure. ",
		effect = [{type = 'onequip', effect = 'end', effectvalue = 5 ,descript = "Endurance + 5"}],
		recipe = '',
		reqs = null,
		cost = 200,
		type = 'gear',
