...
var database = {
	wimbornoutskirts = {
		...
		encounters = [],
		length = 5,
		exits = ['wimborn','forest','prairie','farmlands','riversideplains'], #BBP-Added Farmlands, RiversidePLains
		tags = ['wimborn'],
	...
	prairie = {
		...
		encounters = [],
		length = 5,
		exits = ['wimbornoutskirts','gornoutskirts','sea', 'oasis', 'ruins','forestofrefuge'], #BBP-Added Oasis, Ruins, Refuge
		tags = ['wimborn'],
	...
	amberguardforest = {
		...
		length = 4,
		exits = ['amberguard','witchhut','undercityentrance','taintedforest'], #BBP-Added tainted forest
		tags = ['amberguard'],
	...
	marsh = {
		...
		encounters = [],
		length = 6,
		exits = ['frostfordoutskirts','grove','abandonedvillage','lizardvillage','poisonswamp'], #BBP- added abandonedvillage,lizardvillage, poisonswamp
		tags = ['frostford'],
	...
	greattreeentrance = {
		...
		encounters = [],
		length = 1,
		locationscript = 'greattreeentrance', #Remember to add an appropriate script in expliration.gd. Just copy this script and edit to your needs.
	...
	stormvillage = {
		...
		combat = false,
		code = 'stormvillage',
		name = 'Storm Crown Village',
		description = "This small, rural village looks calm and peaceful. Houses, shops, farms and tanneries line the rock walls of Storm Crown Peak. Seraph's move peacefully about, changing levels with the aid of their wings. You are an anomaly. There are no visitors. This attracts stares.",
		enemies = [],
		encounters = [],
		length = 0,
		locationscript = 'stormvillage',
		exits = ['stormcrown','thepeaks','skysphere'],
		tags = [],
		levelrange = [15,25],
	},
	skysphere = {
	...
	skyisland = {
		...
		encounters = [],
		length = 20,
		exits = ['skysphere','thebeyond','mountains','stormcrown','prairie','gornoutskirts','wimbornoutskirts','frostfordoutskirts'],
		tags = [],
		races = [],
		levelrange = [5,8],
	},
